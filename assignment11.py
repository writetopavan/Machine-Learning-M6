...
# .. your code here ..
import pandas as pd
X=pd.read_csv('C:\\Users\\juhi\\Documents\\python\\DAT210x-master\\DAT210x-master\\Module6\\Datasets\\wheat.data')
...
'''
ordered_satisfaction = ['canadian', 'kama', 'rosa']
...
dct = tree.DecisionTreeClassifier(max_depth=3, random_state=2)
#dct.fit(X,y)
...
benchmark(dct, X_train, X_test, y_train, y_test, 'dct')
drawPlots(dct, X_train, X_test, y_train, y_test, 'dct')
